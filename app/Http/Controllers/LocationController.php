...
class LocationController extends Controller
{
    ...
    public function nonPaginatedData(){
        $query = Location::whereIn('status', ['active', 'Active'])->orderBy('title', 'ASC')->get();
    ...
    public function storeUpdate(Request $request){
        ...
        if($request->id){
            $query = Location::where('id', $request->id)->first();
            $query->update(array('title' => $request->title, 'code' => $request->code,'profile_id' => $request->profile_id,'area' => $request->area));
            $message = 'Data has been updated';
            $log_type = 'update';
        }else{
            $query = Location::create(array('title' => $request->title, 'code' => $request->code,'profile_id' => $request->profile_id,'area' => $request->area));
