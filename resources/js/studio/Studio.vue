<template>
  ...
  >
    <template v-slot:activator="{ props }">
      <v-btn v-bind="props" class="mb-3" :append-icon="mdiCloudUpload">Upload</v-btn>
    </template>
      ...
      <v-card>
        ...
        <v-card-text>
          <div class="d-flex align-center flex-wrap">
            <v-btn
              :class="`${
                selectedTab == 'uploader' ? 'bg-grey-lighten-4' : 'bg-primary'
              } rounded-0`"
              variant="flat"
            ...
            <v-btn
              :class="`${
                selectedTab == 'studio' ? 'bg-grey-lighten-4' : 'bg-primary'
              } rounded-0`"
              variant="flat"
