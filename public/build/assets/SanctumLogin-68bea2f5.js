import{o as h,c as y,r as P,n as E,p as C,a as b,b as l,u as N,d as r,e as T,f as j,w as o,g as a,t as m,V as A,h as g,i as G,j as K,k as z,l as w,m as x,q as F,s as H}from"./app-0d23d45f.js";import{_ as V}from"./_plugin-vue_export-helper-c27b6911.js";const R={},U=c=>(C("data-v-719d11ee"),c=c(),b(),c),W=U(()=>l("div",{class:"gag-guest-bg-fill"},null,-1));function D(c,p){return h(),y("div",{class:"h-screen d-flex flex-column justify-start align-center gag-guest-bg",style:E("background-image: url(./assets/images/login-slider/slider-3.jpg); background-color: #000000")},[W,P(c.$slots,"default",{},void 0,!0)],4)}const J=V(R,[["render",D],["__scopeId","data-v-719d11ee"]]);const O={},Q=c=>(C("data-v-26b261c4"),c=c(),b(),c),X={version:"1.1",id:"Layer_1",xmlns:"http://www.w3.org/2000/svg","xmlns:xlink":"http://www.w3.org/1999/xlink",x:"0px",y:"0px",viewBox:"0 0 309.8 60.2",style:{"enable-background":"new 0 0 309.8 60.2"},"xml:space":"preserve"},Y=Q(()=>l("g",null,[l("path",{id:"Path_71",class:"gag-logo-white",d:`M116.3,28.5c1.2,1.3,1.2,3.3,0,4.6c-0.5,0.5-1.3,0.9-2.1,0.9c-0.1,2.2-0.8,4.4-1.8,6.3
		...
		C61,28.2,59.9,27.5,58.8,27.5`})],-1)),Z=[Y];function q(c,p){return h(),y("svg",X,Z)}const t1=V(O,[["render",q],["__scopeId","data-v-26b261c4"]]),c1={class:"mx-auto px-3 text-center",style:{"z-index":"1","max-width":"320px",width:"100%","margin-top":"100px"}},e1={class:"text-subtitle-1 text-white"},a1={class:"text-error mt-2"},o1={__name:"SanctumLogin",setup(c){const p=N(),k=r("Grandiose Assets"),M=r("grs-asset-wvukt"),v=T();v.authIsLoggedIn==!0&&p.push({path:"/dashboard"});const d=r(!1),s=r({login:"",password:"",url:M.value}),_=r(!1),u=r(""),f=async()=>{d.value=!0,S().then(t=>{if(!t)return;let e="/dashboard",i=t.data.user.username,$=t.data.token;axios.get("/api/fetch/log-profile/"+i+"/"+$).then(n=>{if(!n.data.id){_.value=!0,u.value=n.data,d.value=!1;return}let I=n.data.access.map(B=>B);t.data.access=I,t.data.user.role=n.data.role,t.data.user.profile=n.data,v.setCredentials(t.data).then(()=>{window.location=e})}).catch(n=>{console.log("errrr 1",n)})}).catch(t=>{_.value=!0,u.value=t.response.data.message,d.value=!1})},L=()=>{p.push({path:"reset-password"})},S=async()=>{u.value="";let t={username:s.value.login,password:s.value.password,url:s.value.url};const e=await H.post("/api/sanctumlogin",t);return e.data.status==!1?(_.value=!0,u.value=e.data.message,d.value=!1,!1):e};return(t,e)=>(h(),j(J,null,{default:o(()=>[l("div",c1,[a(t1,{width:"100%"}),l("div",e1,m(k.value),1)]),a(F,{class:"mt-8 pa-3 rounded-lg elevation-3",width:"90%","max-width":"450"},{default:o(()=>[a(A,{class:"px-5 pb-0 primary--text"},{default:o(()=>[g("Login")]),_:1}),a(G,{class:"py-4"},{default:o(()=>[a(K,{autocomplete:"off",ref:"form",onKeydown:z(f,["enter"])},{default:o(()=>[a(w,{modelValue:s.value.login,"onUpdate:modelValue":e[0]||(e[0]=i=>s.value.login=i),variant:"outlined",required:"",class:"border-radius",autocomplete:"off",label:"Enter Employee Code"},null,8,["modelValue"]),a(w,{modelValue:s.value.password,"onUpdate:modelValue":e[1]||(e[1]=i=>s.value.password=i),variant:"outlined",required:"",autocomplete:"off",label:"Enter Password",type:"password"},null,8,["modelValue"]),a(x,{onClick:f,width:"100%",color:"primary",height:"55",large:"",loading:d.value},{default:o(()=>[g("Login")]),_:1},8,["loading"]),a(x,{variant:"text",class:"mt-3",block:"",onClick:L},{default:o(()=>[g("Reset Password")]),_:1}),l("div",a1,m(_.value==!0?u.value:""),1)]),_:1},8,["onKeydown"])]),_:1})]),_:1})]),_:1}))}};export{o1 as default};
